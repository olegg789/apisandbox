                    ...
                    <Group>
                        <Div className="WelcomeBlock">
                            <Title level="1" weight="bold" style={{ marginBottom: 16 }}>
                                {user.first_name}, добро пожаловать в лучшие ссылочки на планете
                                Земля!
                            </Title>
                            <Text weight="regular">
                                Благодаря этому приложению ты в любой момент времени можешь
                                превратить длинную ссылочку в короткую. А еще мы поддерживаем
